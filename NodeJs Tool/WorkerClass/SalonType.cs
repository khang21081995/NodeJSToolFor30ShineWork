...
{
	public class SalonType: TableInfo
{
		...
		public override string TableName() { return "salon_type"; }
		public static string GetIndexName() { return "db30shine_salon__salon_type"; }
}
}