...
{
	public class RatingConfig: TableInfo
{
		...
		public override string TableName() { return "rating_config"; }
		public static string GetIndexName() { return "db30shine_bill__rating_config"; }
}
}