...
{
	public class StaffType: TableInfo
{
		...
		public override string TableName() { return "staff_type"; }
		public static string GetIndexName() { return "db30shine_staff__staff_type"; }
}
}