...
{
	public class SalonService: TableInfo
{
		...
		public override string TableName() { return "salon_service"; }
		public static string GetIndexName() { return "db30shine_service__salon_service"; }
}
}