...
{
	public class AdrRegion: TableInfo
{
		...
		public override string TableName() { return "adr_region"; }
		public static string GetIndexName() { return "db30shine_salon__adr_region"; }
}
}