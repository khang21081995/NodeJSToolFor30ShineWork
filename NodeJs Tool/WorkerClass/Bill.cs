	...
	public class Bill: TableInfo
{
		...
		public override string TableName() { return "bill"; }
		public static string GetIndexName() { return "db30shine_bill__bill"; }
}
}