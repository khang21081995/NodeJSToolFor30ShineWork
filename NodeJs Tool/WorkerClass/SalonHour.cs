...
{
	public class SalonHour: TableInfo
{
		...
		public override string TableName() { return "salon_hour"; }
		public static string GetIndexName() { return "db30shine_salon__salon_hour"; }
}
}