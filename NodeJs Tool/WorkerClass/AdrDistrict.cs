...
{
	public class AdrDistrict: TableInfo
{
		...
		public override string TableName() { return "adr_district"; }
		public static string GetIndexName() { return "db30shine_salon__adr_district"; }
}
}